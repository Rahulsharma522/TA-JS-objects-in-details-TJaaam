...
person.displayName(); // Name : John Reed
let person2 = new Person('Paul', 'Adams');
person2.displayName(); // Name: Pual Adams

person.displayName.call(person2); // Name: Pual Adams
...
outerFn()();//innerItem not be defind
...
let object = {
  ...
  doubleArrow: function () {
    console.log('this inside of outerFn doubleArrow()');//this inside of outerFn doubleArrow()
    console.log(this);
